...
export class AdcionandoConstraintUniq1637715000719 implements MigrationInterface {
    name = 'AdcionandoConstraintUniq1637715000719'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`tipo_equipamento\` ADD UNIQUE INDEX \`IDX_88a45b970e37328bcc8824f047\` (\`modelo\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`equipamento\` ADD UNIQUE INDEX \`IDX_40af66a0c0428d03c626dfea2b\` (\`descricao\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`equipamento\` DROP INDEX \`IDX_40af66a0c0428d03c626dfea2b\``);
        await queryRunner.query(`ALTER TABLE \`equipamento\` ADD CONSTRAINT \`FK_24374677ab4d001eac3f561b76c\` FOREIGN KEY (\`colaboradorId\`) REFERENCES \`colaborador\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`equipamento\` ADD CONSTRAINT \`FK_8d36f3e052b43d2fdbb20a20091\` FOREIGN KEY (\`tipoEquipamentoId\`) REFERENCES \`tipo_equipamento\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`tipo_equipamento\` DROP INDEX \`IDX_88a45b970e37328bcc8824f047\``);
