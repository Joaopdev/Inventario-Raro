...
export class SubindoEstruturaInicial1637355228342 implements MigrationInterface {
    name = 'SubindoEstruturaInicial1637355228342'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`endereco\` (\`id\` int NOT NULL AUTO_INCREMENT, \`cep\` varchar(255) NOT NULL, \`logradouro\` varchar(255) NOT NULL, \`complemento\` varchar(255) NOT NULL, \`numero\` varchar(255) NOT NULL, \`bairro\` varchar(255) NOT NULL, \`estado\` varchar(255) NOT NULL, \`colaboradorId\` int NULL, UNIQUE INDEX \`REL_172b2625739dfaa7edac4c712a\` (\`colaboradorId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`parametro\` (\`id\` int NOT NULL AUTO_INCREMENT, \`tempoMedioEnvio\` int NOT NULL, \`tempoMedioConsumo\` int NOT NULL, \`tempoMedioReposicao\` int NOT NULL, \`quantidadeCritica\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`tipo_equipamento\` (\`id\` int NOT NULL AUTO_INCREMENT, \`tipo\` varchar(255) NOT NULL, \`modelo\` varchar(255) NOT NULL, \`descricao\` varchar(255) NULL, \`quantidade\` int NOT NULL, \`parametroId\` int NULL, UNIQUE INDEX \`REL_112c85cd9206798d83ce6f1ac2\` (\`parametroId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`equipamento\` (\`id\` int NOT NULL AUTO_INCREMENT, \`lote\` varchar(255) NOT NULL, \`descricao\` varchar(255) NOT NULL, \`numeroDeSerie\` varchar(255) NOT NULL, \`dataAquisicao\` datetime NOT NULL, \`tipoEquipamentoId\` int NULL, \`colaboradorId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`colaborador\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nome\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`telefone\` varchar(255) NOT NULL, \`dataInicio\` datetime NOT NULL, \`dataRecisao\` datetime NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
