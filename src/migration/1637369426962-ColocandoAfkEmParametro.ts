...
// export class ColocandoAfkEmParametro1637369426962 implements MigrationInterface {
//     name = 'ColocandoAfkEmParametro1637369426962'

//     public async up(queryRunner: QueryRunner): Promise<void> {
//         await queryRunner.query(`ALTER TABLE \`parametro\` ADD \`tipoEquipamentoId\` int NULL`);
//         await queryRunner.query(`ALTER TABLE \`parametro\` ADD UNIQUE INDEX \`IDX_c60f84bc5e540b089242b9c990\` (\`tipoEquipamentoId\`)`);
...
//         await queryRunner.query(`ALTER TABLE \`tipo_equipamento\` CHANGE \`parametroId\` \`parametroId\` int NULL`);
...
//         await queryRunner.query(`CREATE UNIQUE INDEX \`REL_c60f84bc5e540b089242b9c990\` ON \`parametro\` (\`tipoEquipamentoId\`)`);
...
//         await queryRunner.query(`ALTER TABLE \`movimentacao\` ADD CONSTRAINT \`FK_9cb24bca1d212ecbd4427bf8010\` FOREIGN KEY (\`equipamentoId\`) REFERENCES \`equipamento\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
//         await queryRunner.query(`ALTER TABLE \`movimentacao\` ADD CONSTRAINT \`FK_e6648e1434d11eee2dd0ba31e21\` FOREIGN KEY (\`tipoEquipamentoId\`) REFERENCES \`tipo_equipamento\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
//         await queryRunner.query(`ALTER TABLE \`tipo_equipamento\` CHANGE \`parametroId\` \`parametroId\` int NULL DEFAULT 'NULL'`);
...
//         await queryRunner.query(`ALTER TABLE \`endereco\` ADD CONSTRAINT \`FK_172b2625739dfaa7edac4c712ae\` FOREIGN KEY (\`colaboradorId\`) REFERENCES \`colaborador\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
//         await queryRunner.query(`ALTER TABLE \`parametro\` DROP INDEX \`IDX_c60f84bc5e540b089242b9c990\``);
//         await queryRunner.query(`ALTER TABLE \`parametro\` DROP COLUMN \`tipoEquipamentoId\``);
//     }
